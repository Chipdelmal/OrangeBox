...
globejs(img="/Users/chipdelmal/Documents/School/Research/OrangeBox/MapsStuff/RenderData.png",atmosphere = TRUE)

# globejs(img=system.file("images/world.jpg", package="threejs"),atmosphere=TRUE)

#sample with world temperature data
x <- readGDAL("/Users/chipdelmal/Documents/School/Research/OrangeBox/MapsStuff/worldTemp.TIFF")
...
globejs(img="/Users/chipdelmal/Documents/School/Research/OrangeBox/MapsStuff/worldTemp.jpg",lat=x$lat,long=x$long,val=x$value,color=col,pointsize=0.5,atmosphere=TRUE)
